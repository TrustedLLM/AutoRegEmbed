...
class DataArguments:
    ...
    reference_score_path: str = field(
        default=None, metadata={"help": "Path to reference score"}
    )
...
class AlignmentTrainingArguments(TrainingArguments):
    ...
    aligment_beta: float = field(
        default=0.1, metadata={"help": "aligment_beta"}
    )
    aligment_temperature: float = field(
        default=0.1, metadata={"help": "aligment_temperature"}
    )
