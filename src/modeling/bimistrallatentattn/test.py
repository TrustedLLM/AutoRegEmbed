...
from ..bimistral.configuration_bimistral import BiMistralConfig
...
class BiMistralLatentAttnModelOutput(nn.Module):
    def __init__(self, last_hidden_state, raw_last_hidden_state,**kwargs):
        super(BiMistralLatentAttnModelOutput, self).__init__()
        self.last_hidden_state = last_hidden_state
        self.raw_last_hidden_state = raw_last_hidden_state
...
class BiMistralLatentAttnModel(BiMistralModel):
    ...
    def forward(self, *args, **kwargs):
        ...
        hiddens = base_outputs.last_hidden_state.clone()
        ...
        return BiMistralLatentAttnModelOutput(
            last_hidden_state = hiddens,
            raw_last_hidden_state=base_outputs.last_hidden_state
        )
