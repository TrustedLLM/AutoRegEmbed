...
from src.modeling.modeling_autoregembed import (
    InformationCompressModel
)

from src.information_compress.arguments import (
    ModelArguments, 
    DataArguments, 
    CompressTrainingArguments as TrainingArguments
)

from src.information_compress.data import (
    InformationCompressDataset, 
    DataCollatorForDynamicPadding,
)

from src.information_compress.trainer import (
    InformationCompressTrainer
)
...
def main():
    ...
    model = InformationCompressModel(
    ...
    train_dataset = InformationCompressDataset(path=data_args.train_data_path,
        args=data_args, 
        model=model
    )
    

    trainer = InformationCompressTrainer(
        model=model,
        args=training_args,
